...
<script type="text/javascript" src="js/merchantFormValidation.js"></script>
...
<form:form action="merchantlogin1" method="post" commandName="login" name="loginForm" onsubmit="return isvalidmerchant()" >
<h3><font color="red">Enter Valid E-MailId & Password</font></h3>
    	<table align="center">
    	<tr><td>E-MailId</td>
    		<td></td>
