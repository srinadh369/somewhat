...
<body >
	 ...
	 <form:form action="saveMerchant" method="post" commandName="merchant" name="saveform" onsubmit="return isvalidcustomer()">
	...
	<br><br><br>
	<li color="red" align="center" font-weight="bold" ><a href="merchantlogin">Click Here to Log in</a></li>
